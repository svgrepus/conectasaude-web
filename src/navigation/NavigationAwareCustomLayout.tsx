...
const screens = [
  ...
  { name: 'Medicamentos', component: MedicamentosScreen, path: '/medicamentos' },
  ...
  { name: 'MunicipeDetail', component: MunicipesContainer, path: '/municipes/:id' },
  { name: 'DoencasCronicas', component: DoencaCronicaScreen, path: '/basicos/saude/doencas-cronicas' },
  { name: 'TipoDoenca', component: TipoDoencaScreen, path: '/basicos/saude/tipo-doenca' },
  { name: 'TipoVeiculo', component: TipoVeiculoScreen, path: '/basicos/logistica/tipo-veiculo' },
...
export const NavigationAwareCustomLayout: React.FC<NavigationAwareCustomLayoutProps> = ({ isDarkMode = false }) => {
  return (
    <Stack.Navigator 
      screenOptions={{ 
        headerShown: false,
